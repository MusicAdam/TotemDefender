...
public class TotemDefender extends ApplicationAdapter {
	...
	private void loadResources(){
		...
		assetManager.load("slingshot1.png", Texture.class, textureParam);
		assetManager.load("band.png", Texture.class, textureParam);
		assetManager.load("band1.png", Texture.class, textureParam);
